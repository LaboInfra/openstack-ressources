resource "openstack_images_image_v2" "windows_server_2016_standard_core" {
  ...
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_server_2016_standard_core.raw"
...
resource "openstack_images_image_v2" "windows_server_2016_standard" {
  ...
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_server_2016_standard.raw"
  container_format = "bare"
  disk_format      = "raw"
  visibility       = "public"
  protected        = false
...
resource "openstack_images_image_v2" "windows_server_2019_standard_core" {
  ...
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_server_2019_standard_core.raw"
  container_format = "bare"
  disk_format      = "raw"
  visibility       = "public"
  protected        = false
...
resource "openstack_images_image_v2" "windows_server_2019_standard" {
  ...
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_server_2019_standard.raw"
  container_format = "bare"
  disk_format      = "raw"
  visibility       = "public"
  protected        = false
...
resource "openstack_images_image_v2" "windows_server_2022_standard_core" {
  ...
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_server_2022_standard_core.raw"
  container_format = "bare"
  disk_format      = "raw"
  visibility       = "public"
  protected        = false
...
resource "openstack_images_image_v2" "windows_server_2022_standard" {
  ...
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_server_2022_standard.raw"
  container_format = "bare"
  disk_format      = "raw"
  visibility       = "public"
  protected        = false
...
resource "openstack_images_image_v2" "windows_10_pro" {
  name             = "Windows 10 Pro"
  image_source_url = "https://s3.netbytes.space/cloud-images/windows_10_pro.raw"
  container_format = "bare"
  disk_format      = "raw"
  visibility       = "public"
  protected        = false
